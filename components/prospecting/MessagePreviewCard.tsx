  ...
  return (
    <section className="flex h-full flex-col rounded-lg border border-border bg-card p-3">
      ...
      <div className="flex flex-1 items-start overflow-hidden">
        <div className="relative w-full max-w-[92%] rounded-lg rounded-tl-sm bg-[oklch(0.21_0.014_252)] px-3 py-2">
          <div className="max-h-28 overflow-y-auto pr-1 font-sans text-[11px] leading-5 text-foreground/90">
            {current.corpo
